...
usersRoutes.post('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, master_password, createUserService, user;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = request.body, name = _a.name, email = _a.email, master_password = _a.master_password;
                createUserService = tsyringe_1.container.resolve(CreateUserService_1.default);
                return [4 /*yield*/, createUserService.create({ name: name, email: email, master_password: master_password })];
            case 1:
                user = _b.sent();
...
usersRoutes.get('/', ensureAuthenticated_1.default, function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
