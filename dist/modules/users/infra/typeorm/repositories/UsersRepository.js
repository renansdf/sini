...
var User_1 = __importDefault(require("@modules/users/infra/typeorm/schemas/User"));
    ...
    UsersRepository.prototype.create = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        user = this.ormRepository.create({ name: name, email: email, master_password: master_password });
